export default {
	...
	smtp: {
		...
		configuration: {
			...
			replace: 'Replaced configuration',
			replace_error: 'Can\'t replace configuration',
		...
		message: {
			...
			replace: 'Replaced message',
			replace_error: 'Can\'t replace message',
